  ...
  return (
    <main id="main-content" style={{ maxWidth: "var(--container-page)", margin: "0 auto", padding: "var(--space-7) var(--gutter-page) 0" }}>
        ...
        <div style={{ gridColumn: "9 / span 4", position: "sticky", top: 110 }}>
          ...
          <div style={{ marginTop: "var(--space-7)" }}>
            <Sheet>
              ...
              <div className="bm-data" style={{ fontSize: "13px", lineHeight: 2, marginTop: "var(--space-4)", color: "var(--text-secondary)" }}>
      ...
      <Dialog open={guide} title="Size guide" onClose={() => setGuide(false)} footer={<Button variant="outline" size="sm" onClick={() => setGuide(false)}>Close</Button>}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", font: "var(--type-data)", fontSize: "13px" }}>
          <tbody>
            <tr>
