...
export function NoticeView() {
  ...
  const { say } = useCart();
  return (
    <main id="main-content" style={{ maxWidth: "var(--container-page)", margin: "0 auto", padding: "var(--space-9) var(--gutter-page) 0" }}>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(12,1fr)", gap: "var(--gutter-column)", alignItems: "start" }}>
        <div style={{ gridColumn: "1 / span 6" }}>
          ...
          >
            ...
            {sent ? (
              <span className="bm-data" style={{ fontSize: "13px", color: "var(--text-accent)" }}>
        ...
        <div style={{ gridColumn: "8 / span 5", position: "relative", marginTop: "var(--space-10)" }}>
          <ImagePlate ratio="portrait" plate="PLATE 07" stock="MAILING LIST" caption="Placeholder — not brand photography" treatment="deep" deckle src={notice} alt="Mailing list photography, placeholder" />
